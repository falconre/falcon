...
const AMD64REGISTERS : &'static [X86Register] = &[
    ...
    X86Register { name: "rcx", capstone_reg: x86_reg::X86_REG_ECX, full_reg: x86_reg::X86_REG_RCX, offset: 0, bits: 64, mode: Mode::Amd64 },
    ...
    X86Register { name: "rdx", capstone_reg: x86_reg::X86_REG_EDX, full_reg: x86_reg::X86_REG_RDX, offset: 0, bits: 64, mode: Mode::Amd64 },
