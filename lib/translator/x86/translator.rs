...
fn raise_fp(name: &str, control_flow_graph: &mut ControlFlowGraph) -> Result<()> {
    let block_index = {
        let block = control_flow_graph.new_block()?;

        block.raise(expr_scalar(name, 1));
...
pub(crate) fn translate_block(mode: Mode, bytes: &[u8], address: u64)
    ...
    let semantics = Semantics::new(mode);
    ...
    loop {
        ...
        if let capstone::InstrIdArch::X86(instruction_id) = instruction.id {
            ...
            try!(match instruction_id {
                ...
                capstone::x86_insn::X86_INS_CDQE => semantics.cdqe(&mut instruction_graph, &instruction),
                ...
                capstone::x86_insn::X86_INS_F2XM1  => raise_fp("f2xm1", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FABS   => raise_fp("fabs", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FADD   => raise_fp("fadd", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FADDP  => raise_fp("faddp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FCHS   => raise_fp("fchs", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FCOMP  => raise_fp("fcomp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FCOMPP => raise_fp("fcompp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FDIV   => raise_fp("fdiv", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FDIVR  => raise_fp("fdivr", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FDIVRP => raise_fp("fdivrp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FFREE  => raise_fp("ffree", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FILD   => raise_fp("fild", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FINCSTP => raise_fp("fincstp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FISTP  => raise_fp("fistp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FLDCW  => raise_fp("fldcw", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FLD    => raise_fp("fld", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FLD1   => raise_fp("fdl1", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FLDENV => raise_fp("fldenv", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FLDL2E => raise_fp("fldl2e", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FLDLN2 => raise_fp("fldln2", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FLDZ   => raise_fp("fldz", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FDIVP  => raise_fp("fdivp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FMUL   => raise_fp("fmul", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FMULP  => raise_fp("fmulp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FNCLEX => raise_fp("fnclex", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FNSTENV => raise_fp("fnstenv", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FNSTCW => raise_fp("fnstcw", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FNSTSW => raise_fp("fnstsw", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FRNDINT => raise_fp("frndint", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FSCALE => raise_fp("fscale", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FST    => raise_fp("fst", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FSTP   => raise_fp("fstp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FSUB   => raise_fp("fsub", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FSUBP  => raise_fp("fsubp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FSUBR  => raise_fp("fsubr", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FSUBRP => raise_fp("fsubrp", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FTST   => raise_fp("ftst", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FUCOMI => raise_fp("fucomi", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FUCOMPI => raise_fp("fucompi", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FXAM   => raise_fp("fxam", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FXCH   => raise_fp("fxch", &mut instruction_graph),
                capstone::x86_insn::X86_INS_FYL2X  => raise_fp("fyl2x", &mut instruction_graph),
                ...
                capstone::x86_insn::X86_INS_PAUSE => semantics.nop(&mut instruction_graph, &instruction),
                ...
                capstone::x86_insn::X86_INS_SAHF => semantics.sahf(&mut instruction_graph, &instruction),
                ...
                capstone::x86_insn::X86_INS_SCASW => semantics.scasw(&mut instruction_graph, &instruction),
                ...
                capstone::x86_insn::X86_INS_SYSCALL => semantics.syscall(&mut instruction_graph, &instruction),
            ...
            if detail.prefix.contains(&(capstone_sys::x86_prefix::X86_PREFIX_REPNE as u8)) {
                semantics.repne_prefix(&mut instruction_graph, &instruction)?;
            }
