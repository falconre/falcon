...
fn unhandled_intrinsic(control_flow_graph: &mut ControlFlowGraph, instruction: &capstone::Instr)
    -> Result<()> {
    ...
    loop {
        ...
        if let capstone::InstrIdArch::X86(instruction_id) = instruction.id {
            ...
            try!(match instruction_id {
                ...
                capstone::x86_insn::X86_INS_F2XM1  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FABS   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FADD   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FADDP  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FCHS   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FCOMP  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FCOMPP => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FDIV   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FDIVR  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FDIVRP => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FFREE  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FILD   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FINCSTP => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FISTP  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FLDCW  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FLD    => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FLD1   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FLDENV => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FLDL2E => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FLDLN2 => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FLDZ   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FDIVP  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FMUL   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FMULP  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FNCLEX => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FNSTENV => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FNSTCW => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FNSTSW => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FRNDINT => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FSCALE => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FST    => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FSTP   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FSUB   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FSUBP  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FSUBR  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FSUBRP => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FTST   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FUCOMI => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FUCOMPI => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FXAM   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FXCH   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_FYL2X  => unhandled_intrinsic(&mut instruction_graph, &instruction),
                ...
                capstone::x86_insn::X86_INS_INT3   => unhandled_intrinsic(&mut instruction_graph, &instruction),
                ...
                capstone::x86_insn::X86_INS_MOVDQA => unhandled_intrinsic(&mut instruction_graph, &instruction),
                ...
                capstone::x86_insn::X86_INS_PSHUFD => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_PSUBQ => semantics.psubq(&mut instruction_graph),
                capstone::x86_insn::X86_INS_PUNPCKLBW => unhandled_intrinsic(&mut instruction_graph, &instruction),
                capstone::x86_insn::X86_INS_PUNPCKLWD => unhandled_intrinsic(&mut instruction_graph, &instruction),
